 ...
 */
final class Version20190613091612 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE product ADD seller_id INT NOT NULL, ADD category_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE product DROP seller_id, DROP category_id');
    }
}
